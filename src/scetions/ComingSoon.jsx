      ...
      <div className="h-full col-center gap-10 ">
        <div className="text-wrapper text-xl text-center">
          ...
          <p className="max-w-4xl text-[#fafafa] p-2">
            ...
            be authentic, accessible, and effortlessly elegant. That’s why every
            piece is made with care, quality fabrics, and a focus on detail —
            all at prices that make sense. Join the new wave of ethnic fashion.
          </p>
        </div>
